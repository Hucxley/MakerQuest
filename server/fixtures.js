if (Archetypes.find().count() === 0) {
  ...
  Archetypes.insert({
    ...
    qualities: ["/>_ Initiate data integrity protocol on module LTM-001, Unit A. ","/>_ Response code 301: Resource archived by 'Self' with header, 'The Creator'","/>_ Protocol forwarded to the indexed archive. ","/>_ Error 409:  Request conflicts with prioritized processes: (['Self.Relocate(locationData, patternSelector)', 'Self.Discover(referenceData, patternSelector)', 'Self.Manufacture(module, materials, equippedItems)']).","/>_ Forwarded protocol will restart when resources available."],
  ...
  Archetypes.insert({
    ...
    qualities: ["Using arcane knowledge gained from a vast array of languages and scholars, Summoners can create nearly anything they choose",'Summoning requires the ability to decipher esoteric enchantments without error.',"When Summoners mis-translate, or stray from the exact instructions written for the specific manifestation they are seeking, disastrous (and sometimes hilarious) results often occur."],
  ...
  Archetypes.insert({
    ...
    qualities: ["Tinkerers are the type of people who can put 3 paper clips, a piece of gum, and a small servo motor together to change the channel on the TV without getting up","They are always taking things apart, putting them back together with something they found last week at the scrap heap","While sometimes known for their eccentric joy at finding discarded or forgotten items, they are sometimes reviled for 'improving' a loved ones' prize possession"],
